...
static bool LoadConfig(const char* name){
    ...
    g_aimbotFov = Clampf(g_aimbotFov, 0.5f, 60.f);
    g_aimbotSmooth = Clampf(g_aimbotSmooth, 1.f, 50.f);
    ...
    g_espBoxThick = Clampf(g_espBoxThick, 0.5f, 5.f);
    g_espNameSize = Clampf(g_espNameSize, 8.f, 32.f);
    g_espMaxDist = Clampf(g_espMaxDist, 1.f, 500.f);
    g_espScale = Clampf(g_espScale, 0.5f, 2.f);
    g_fovValue = Clampf(g_fovValue, 30.f, 160.f);
    g_snowDensity = (g_snowDensity < 1) ? 1 : (g_snowDensity > 5) ? 5 : g_snowDensity;
    g_tbDelay = (g_tbDelay < 0) ? 0 : (g_tbDelay > 500) ? 500 : g_tbDelay;
    g_radarRange = Clampf(g_radarRange, 200.f, 8000.f);
    g_radarSize = Clampf(g_radarSize, 80.f, 400.f);
